...
const sections = [
  ...
  },
  {
    ...
    icon: BookMarked,
    title: 'Skills',
    description: 'Instrucciones y recursos que Claude carga dinámicamente para tareas especializadas.',
    count: '3 tipos',
    available: true,
  ...
  },
  {
    ...
    icon: Users,
    title: 'Sub Agentes',
    description: 'Delega subtareas a agentes especializados con contexto aislado y herramientas propias.',
    count: 'patrón EPL',
    available: true,
